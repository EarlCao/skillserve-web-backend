...
return new class extends Migration
{
    private const PERMISSIONS = [
        'manage data', 'export system data', 'archive records',
        'restore archived records', 'restore deleted records', 'manage deleted records',
    ];
    ...
    public function up(): void
    {
        ...
        DB::table('role_has_permissions')->insertOrIgnore($roles->flatMap(fn ($roleId) => $permissions->map(fn ($permissionId): array => ['permission_id' => $permissionId, 'role_id' => $roleId]))->all());
    }
