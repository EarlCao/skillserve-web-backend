...
class ClientCatalogController extends Controller
{
    ...
    #[OA\Get(
        ...
        parameters: [
            ...
            new OA\Parameter(name: 'min_rating', in: 'query', description: 'Lowest average rating a service may carry', schema: new OA\Schema(type: 'number', format: 'float', minimum: 0, maximum: 5)),
    ...
    #[OA\Get(
        ...
        parameters: [
            ...
            new OA\Parameter(name: 'category_id', in: 'query', schema: new OA\Schema(type: 'integer')),
            new OA\Parameter(name: 'subcategory_id', in: 'query', schema: new OA\Schema(type: 'integer')),
            new OA\Parameter(name: 'featured', in: 'query', description: 'Only providers administrators have featured', schema: new OA\Schema(type: 'boolean')),
            new OA\Parameter(name: 'min_rating', in: 'query', description: 'Lowest average rating a provider may carry', schema: new OA\Schema(type: 'number', format: 'float', minimum: 0, maximum: 5)),
            new OA\Parameter(name: 'available', in: 'query', description: 'Only providers taking new bookings who have at least one service that can be booked online', schema: new OA\Schema(type: 'boolean')),
            new OA\Parameter(name: 'available_day', in: 'query', description: 'Only providers publishing hours on this weekday (0 = Sunday … 6 = Saturday)', schema: new OA\Schema(type: 'integer', minimum: 0, maximum: 6)),
