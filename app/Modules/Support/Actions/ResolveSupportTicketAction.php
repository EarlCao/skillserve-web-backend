...
final class ResolveSupportTicketAction extends BaseAction
{
    public function handle(SupportTicket $ticket, User $actor, string $resolutionNote): SupportTicket
    {
        ...
        return $ticket->fresh(['requester:id,name,email,role_id', 'assignedTo:id,name,email', 'assignedBy:id,name,email', 'resolvedBy:id,name,email', 'messages.author:id,name,email']);
    }
}
